...
详细的开发计划请查看 [ROADMAP.md](ROADMAP.md)。

## 🤝 参与贡献

我们欢迎任何形式的贡献！请查看 [CONTRIBUTING.md](CONTRIBUTING.md) 了解贡献指南。
...
本项目采用 **反 996 许可证（Anti-996 License）**。

- **反 996 许可证** - 倡导工作与生活平衡，反对过度加班文化
- 查看 [LICENSE](LICENSE) 了解完整协议

反 996 许可证是开发者创建的一个软件许可证，旨在抗议科技公司中普遍存在的"996工作制"（早9点到晚9点，每周6天）。使用此许可证，我们倡导：
...
**注意**: 此许可证在某些司法管辖区可能不适用于商业用途，请自行斟酌使用。
