...
export const translations = {
  "zh-CN": {
    ...
    aboutVersion: "版本",
    aboutDescription: "每日自动获取并更新必应壁纸，支持高清壁纸下载和桌面壁纸设置。",
  ...
  "en-US": {
    ...
    noWallpapersHint: "Click the refresh button above to get the latest wallpapers",
    wallpaperError: "Failed to set wallpaper",
    setWallpaper: "Set Wallpaper",
    retry: "Retry",
    imageLoadError: "Load Failed",
    imageLoadErrorHint: "Image may still be downloading, please use the button below to retry",
    ...
    aboutDescription: "Automatically fetch and update Bing wallpapers daily, with support for HD wallpaper downloads and desktop wallpaper settings.",
